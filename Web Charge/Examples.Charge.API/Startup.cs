    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ExampleContext>(options =>
            {
                ...
                options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection").Replace("[DataDirectory]", path), b => b.MigrationsAssembly("Examples.Charge.Infra.Data.Configuration"));
